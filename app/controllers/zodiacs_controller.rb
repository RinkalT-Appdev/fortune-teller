class ZodiacsController < ApplicationController
  def ram
    ...
    render("zodiacs_templates/ram.html.erb")
  end
  ...
  def bull
    ...
    render("zodiacs_templates/bull.html.erb")
  end
  ...
  def twins
    ...
    render("zodiacs_templates/twins.html.erb")
  end
  ...
  def crab
    ...
    render("zodiacs_templates/crab.html.erb")
  end
  ...
  def lion
    ...
    render("zodiacs_templates/lion.html.erb")
  end
  ...
  def maiden
    ...
    render("zodiacs_templates/maiden.html.erb")
  end
  ...
  def scales
    ...
    render("zodiacs_templates/scales.html.erb")
  end
  ...
  def scorpion
    ...
    render("zodiacs_templates/scorpion.html.erb")
  end
  ...
  def archer
    ...
    render("zodiacs_templates/archer.html.erb")
  end
  ...
  def goat
    ...
    render("zodiacs_templates/goat.html.erb")
  end
  ...
  def waterbearer
    ...
    render("zodiacs_templates/waterbearer.html.erb")
  end
  ...
  def fish
    ...
    render("zodiacs_templates/fish.html.erb")
  end
end
